...
export default class Viewmyproducts extends Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <Text style={{ fontSize: 16, paddingTop: 10, paddingBottom: 10 }}>Products</Text>
                    <ListView
                        style={{
        ...
        return (
            <TouchableOpacity onPress={() => this.herbalistfunc(trips)}>
                <View style={styles.card}>
                    ...
                    <Image source={{ uri: trips.image }} style={{ height: '100%', width: '100%', borderRadius:200 }} />

                    </View> 
                    <View style={styles.Datacard}>
                        <Text style={{ fontSize: 16, color: '#fff', paddingLeft: 30, paddingTop: 10 }}>{trips.herbname}</Text>

                        <View style={{ flexDirection: 'row' }}>

                            <Text style={{ marginTop: 5, color: '#fff', paddingLeft: 30 }} >{trips.cost}</Text>
                        </View>
